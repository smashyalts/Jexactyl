...
const DiscordFormContainer = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className={'w-full flex'}>
            <Wrapper>
                <h2 className={`text-3xl text-center text-neutral-100 font-medium py-4`}>Login to {name}</h2>
                ...
                <div className={`md:flex w-full bg-neutral-900 shadow-lg rounded-lg p-6 md:pl-0 mx-1`}>
                    <div className={`flex-none select-none mb-6 md:mb-0 self-center`}>
                        <img src={'/assets/svgs/discord.svg'} className={`block w-48 p-8 md:w-64 mx-auto`} />
                    </div>
