    ...
    <>
        {noContainer ? (
            <div className={`flex justify-center`}>
                <div
                    className={`w-full sm:w-3/4 md:w-1/2 p-12 md:p-20 bg-neutral-800 rounded-lg shadow-lg text-center relative`}
                >
                    ...
                    <h2 className={`mt-10 font-bold text-4xl`}>{title}</h2>
